...
| 文件 | 类型 | 用途 | 依赖（插件 · 数据源） | 引用 |
|---|---|---|---|---|
| `2026-W18-20260502.js` | js-metabind | 一次性 Meta Bind 动作（带日期戳，疑似可归档）| JS Engine · — | — |
...
**带日期戳的文件**：`2026-W18-20260502.js`、`读书笔记-20260408.js`
...
- 日期戳一次性脚本混入库：`读书笔记-20260408.js`、`2026-W18-20260502.js`。
- 8 个零引用 widget（见「待确认/清理候选」）。
- `monthlyAmountEdit.js` / `2026-W18` 依赖 JS Engine 注入全局，无存在性 guard。
